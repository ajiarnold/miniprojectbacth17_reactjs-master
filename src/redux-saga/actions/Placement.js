...
export const doUpdatePlacementRequest = (payload) => ({
  type: ActionType.EDIT_PLACEMENT_REQUEST,
  payload,
});
export const doUpdatePlacementSucceed = (payload) => ({
  type: ActionType.EDIT_PLACEMENT_SUCCEED,
  payload,
});
export const doUpdatePlacementFailed = (payload) => ({
  type: ActionType.EDIT_PLACEMENT_FAILED,
  payload,
});
